...
def train():
    ...
    with g.as_default():
        ...
        checkpoint_saver_hook = tf.train.CheckpointSaverHook(
            args.output_dir, save_steps=child_ops["num_train_batches"], saver=saver)
        ...
        if args.controller_training and args.controller_sync_replicas:
        ...
        with tf.train.SingularMonitoredSession(
                config=config, hooks=hooks, checkpoint_dir=args.output_dir) as sess:
                ...
                if actual_step % ops["eval_every"] == 0:
                    ...
                    if (args.controller_training and
                        ...
                        for ct_step in range(args.controller_train_steps *
                            ...
                            loss, reward, new_reward, cycle_norm, entropy, lr, gn, val_acc, bl, skip_num, _ = sess.run(
                                run_ops)
