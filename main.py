...
parser.add_argument('--train_batch_size', type=int, default=64, metavar='batch_size', help='')  # TODO
parser.add_argument('--eval_batch_size', type=int, default=64, metavar='batch_size', help='')  # TODO
...
parser.add_argument('--child_num_layers', type=int, default=3, help='')
parser.add_argument('--child_filter_size', type=int, default=5, help='')
parser.add_argument('--child_out_filters', type=int, default=16, help='')
